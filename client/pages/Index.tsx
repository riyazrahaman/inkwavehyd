    ...
    <div className="min-h-screen bg-white">
      ...
      <header className="border-b border-gray-100 px-4 lg:px-24 py-4">
        <div className="flex items-center justify-between gap-4 lg:gap-8">
          {/* Logo */}
          <div className="text-2xl lg:text-3xl font-black text-black tracking-tight">
            inkwavehyd
          </div>
          ...
          <nav className="hidden lg:flex items-center gap-6">
            ...
            <span className="cursor-pointer hover:text-gray-600 transition-colors font-medium">
              On Sale
            </span>
            <span className="cursor-pointer hover:text-gray-600 transition-colors font-medium">
              New Arrivals
          ...
          <div className="flex items-center gap-3 lg:gap-4">
            <Search
              size={20}
              className="lg:hidden cursor-pointer hover:text-gray-600 transition-colors"
            />
            <Link to="/cart">
              <ShoppingCart
                size={20}
        ...
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center max-w-7xl mx-auto">
          <div className="space-y-6 lg:space-y-8">
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-black text-black leading-tight lg:leading-none tracking-tight">
              FIND CLOTHES
              <br className="hidden lg:block" /> THAT MATCHES
              <br className="hidden lg:block" /> YOUR STYLE
            </h1>
            ...
            <Link
              to="/category/casual"
              className="bg-black text-white px-12 py-4 rounded-full text-base lg:text-lg font-medium hover:bg-gray-800 transition-colors inline-block text-center"
            >
              Shop Now
            </Link>
      ...
      <section className="bg-black py-8 lg:py-12">
        <div className="px-4 lg:px-24 max-w-7xl mx-auto">
          <div className="flex justify-center items-center gap-6 sm:gap-8 lg:gap-16 flex-wrap">
            <div className="text-white font-bold text-lg sm:text-xl lg:text-3xl">
              VERSACE
            </div>
            <div className="text-white font-bold text-lg sm:text-xl lg:text-3xl">
              ZARA
            ...
            <div className="text-white font-bold text-lg sm:text-xl lg:text-3xl hidden sm:block">
              Calvin Klein
            </div>
          </div>
        </div>
      ...
      <section className="px-4 lg:px-24 py-12 lg:py-16 max-w-7xl mx-auto">
        <h2 className="text-3xl lg:text-5xl font-black text-center mb-8 lg:mb-12 tracking-tight">
          NEW ARRIVALS
        </h2>
          ...
          {[
            {
              id: "1",
              image:
                "https://api.builder.io/api/v1/image/assets/TEMP/22995a49d04a8f3970a4eb63b975cb6b7fe646ab?width=592",
            ...
            >
              ...
              <h3 className="font-bold text-sm lg:text-lg mb-2 lowercase line-clamp-2">
                {product.name}
              </h3>
              ...
              <div className="flex flex-wrap items-center gap-1 lg:gap-2">
                ...
                {product.originalPrice && (
                  <>
                    <span className="text-gray-400 line-through text-sm lg:text-lg">
                      {product.originalPrice}
                    </span>
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-6">
          {[
            ...
            },
            {
              id: "8",
              image:
                "https://api.builder.io/api/v1/image/assets/TEMP/39c3606a47758a2493ba802006ec1bceb53bda67?width=504",
      ...
      <section className="px-4 lg:px-24 py-16">
        ...
        <div className="flex gap-6 overflow-x-auto pb-4">
          {[
            ...
            <div
              key={index}
              className="flex-shrink-0 w-80 p-6 border border-gray-200 rounded-xl"
            >
